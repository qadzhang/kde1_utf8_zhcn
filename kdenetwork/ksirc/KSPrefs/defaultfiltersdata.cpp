	...
	Inherited( parent, name, 0 )
{
	...
	SLE_SampleColourNick = new  QLineEdit( this, "LineEdit_1" );
	...
	SLE_SampleHighlight = new  QLineEdit( this, "LineEdit_2" );
	...
	usHighlightColour = new  QComboBox( FALSE, this, "ComboBox_1" );
	...
	NickFColour = new  QComboBox( FALSE, this, "ComboBox_2" );
	...
	NickBColour = new  QComboBox( FALSE, this, "ComboBox_3" );
...
#include "defaultfiltersdata.moc" /* TQt3 迁移:AUTOMOC 时代未写显式 moc include,补齐(编译单元内提供 vtable) */
