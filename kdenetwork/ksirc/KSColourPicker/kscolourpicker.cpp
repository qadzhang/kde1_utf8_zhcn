...
//                        *kSircConfig->colour_background); 
  ...
  MappedButtons = new PushButtons((KSPainter::maxcolour*2)+2);  /* TQt3 migration: Qt1 named-new syntax removed */
  int XOffset = 0;
  int YOffset = 0;
...
#include "kscolourpicker.moc" /* TQt3 migration: add explicit moc include for vtable */
