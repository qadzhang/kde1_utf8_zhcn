...
TQStringList OpenGLWidgetInterface::featureList() const
{
    TQStringList list;
...
TQWidget* OpenGLWidgetInterface::create( const TQString &description, TQWidget* parent, const char* name )
{
    TQWidget* w = 0;
...
TQString OpenGLWidgetInterface::group( const TQString &description ) const
{
    if ( description == "GLWidget" )
	return "Views";
...
TQIconSet OpenGLWidgetInterface::iconSet( const TQString &description ) const
{
    if ( description == "GLWidget" )
	return TQIconSet( (const char**)cube_xmp );
    return TQIconSet();
}

TQString OpenGLWidgetInterface::includeFile( const TQString &description ) const
{
    if ( description == "GLWidget" )
        return "glwidget.h";
    return TQString::null;
...
TQString OpenGLWidgetInterface::whatsThis( const TQString &description ) const
{
    if ( description == "GLWidget" )
