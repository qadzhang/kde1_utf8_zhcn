...
public:
    CIndent();
    virtual ~CIndent() {}
    void indent( TQTextDocument *doc, TQTextParagraph *parag, int *oldIndent, int *newIndent );
...
private:
    void reindent();
    void indentLine( TQTextParagraph *p, int &oldIndent, int &newIndent );
    void tabify( TQString &s );
