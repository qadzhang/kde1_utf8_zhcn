...
Window tqt_XCreateWindow( const TQWidget*, Display *display, Window parent,
...
Window tqt_XCreateSimpleWindow( const TQWidget*, Display *display, Window parent,
...
void tqt_XDestroyWindow( const TQWidget*, Display *display, Window window )
{
