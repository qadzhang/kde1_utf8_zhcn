...
class DVIFile 
{
	/* [KDE1 Revival 2026] Q_OBJECT removed: no signals/slots here; the
	   meta object had no TU (vtable undefined at link). */
public:
	DVIFile(){}
	~DVIFile(){};
...
#include "print.moc" /* [KDE1 Revival 2026] TQt3 moc linkage */
