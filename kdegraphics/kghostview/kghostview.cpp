...
#include <unistd.h>
#include <qmsgbox.h>
/* [KDE1 Revival 2026] X11 headers leak a "index"->strchr compatibility macro
   that breaks TQListBox::index() declarations included later. */
#undef index
#undef rindex
...
void KGhostview::openNetFile( const char *_url )
{
	...
	QString string;
	netFile = _url; /* [KDE1 Revival 2026] TQt3 COW: detach removed */
