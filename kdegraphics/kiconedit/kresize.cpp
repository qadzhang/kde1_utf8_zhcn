...
KResize::~KResize()
{
  tqWarning("KResize - destructor");
  tqWarning("KResize - destructor: done");
}
...
bool KResize::eventFilter(QObject *obj, QEvent *e)
{
  if ( e->type() == Event_KeyPress && obj == this && !testWFlags(WType_Modal))
  {
    ...
    {
      tqWarning("KResize: Received keyevent");
      return true;
    }
  }
  return false;
...
#include "kresize.moc" /* [KDE1 Revival 2026] TQt3 moc linkage */
